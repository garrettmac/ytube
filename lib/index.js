...
var ytube = function () {
  ...
  _createClass(ytube, [{
    ...
    value: async function getChannelsLatestVideos(channelId) {
      ...
      try {
        var response = await this.YouTubeAPI('search?order=date&part=snippet&channelId=' + channelId + '&maxResults=' + count).then(function (x) {
          return x.data;
        }).then(function (o) {
          var nextPageToken = o.nextPageToken;
          var totalResults = o.pageInfo.totalResults;
          var resultsPerPage = o.pageInfo.resultsPerPage;
          return { nextPageToken: nextPageToken, totalResults: totalResults, resultsPerPage: resultsPerPage, videos: o.items.map(function (o) {
